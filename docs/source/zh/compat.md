...
目前支持来自Serene Seasons的季节性作物标签。然而，我们建议使用Ecliptic Seasons和即将推出的数据包中的标签，特别是因为季节标签缺乏湿度信息。

对于作物生长，我们主要支持Neo/Forge生态系统中作物方块的生长，以及树苗的生长。如果作物不支持Forge生态系统，或者在Forge生态系统上无法正常工作，仅靠标签是无法控制的。对于其他控制作物生长的模组，如Serene Seasons，也是如此。
