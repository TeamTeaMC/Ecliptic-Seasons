...
public class Lang_EN extends LangHelper {
    ...
    private void addConfigLang() {
        ...
        add("eclipticseasons.configuration.GreenHouseMaxHeight", "Greenhouse Max Height");
        add("eclipticseasons.configuration.UseBoxDistance", "Use Box Distance");

        add("eclipticseasons.configuration.SeasonCoreRange", "Range of Season Core");

        add("eclipticseasons.configuration.SeasonGreenhouse", "Seasonal Greenhouse Particles");
        add("eclipticseasons.configuration.SeasonGreenhouseParticleSpawnCount", "Seasonal Greenhouse Particle Spawn Number");

        add("eclipticseasons.configuration.BoneMealFailureMessage", "Bone Meal Failure Message");
        add("eclipticseasons.configuration.boneMealFailureMessageOnlyImpossible", "Bone Meal Failure Message Only Impossible");
        add("eclipticseasons.configuration.BoneMealConsumeOnFailure", "Bone Meal Consumption on Failed Use");

        add("eclipticseasons.configuration.SpringDayTimes", "Spring Daylight Duration");
        add("eclipticseasons.configuration.SummerDayTimes", "Summer Daylight Duration");
        add("eclipticseasons.configuration.AutumnDayTimes", "Autumn Daylight Duration");
        add("eclipticseasons.configuration.WinterDayTimes", "Winter Daylight Duration");
        add("eclipticseasons.configuration.NoneDayTimes", "Default Daylight Duration");

        add("eclipticseasons.configuration.ForceBlocksNotSnowy", "Force Blocks Not Snowy");

        add("eclipticseasons.configuration.WeatherFrontBias", "Increase the Weighting of Forward Weather Sampling");
        add("eclipticseasons.configuration.WeatherTransitionSpeed", "Speed of Weather Transitions");

        add("eclipticseasons.configuration.EnableLocalInfoAndCalendar", "Enable Local Info and Calendar");
