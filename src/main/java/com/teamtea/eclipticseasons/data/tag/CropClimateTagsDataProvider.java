...
public class CropClimateTagsDataProvider extends TagsProvider<AgroClimaticZone> {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(CropClimateTags.OVERWORLD).addAll(List.of(AgroClimateRegistry.TEMPERATE, AgroClimateRegistry.COLD, AgroClimateRegistry.HOT, AgroClimateRegistry.DESERT));
    }
}
