...
public class MultiPartBakedModelLike extends MultiPartBakedModel {
    ...
    // Hey, it's not a forge multipart model, we not care about the render types because it not work correctly
    @Override
    public @NotNull List<BakedQuad> getQuads(@Nullable BlockState pState, @Nullable Direction pDirection, @NotNull RandomSource pRandom, @NotNull ModelData modelData, @Nullable RenderType renderType) {
