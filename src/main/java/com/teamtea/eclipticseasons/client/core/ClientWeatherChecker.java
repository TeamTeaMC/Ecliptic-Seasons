...
public class ClientWeatherChecker {
    ...
    public static float updateRainLevel(ClientLevel clientLevel) {
        ...
        if (Minecraft.getInstance().cameraEntity instanceof Player player) {
            ...
            rainLevel = getStandardRainLevel(1f, clientLevel,clientLevel.getBiome(Minecraft.getInstance().player.blockPosition()));
    ...
    public static float updateThunderLevel(ClientLevel clientLevel) {
        ...
        if (Minecraft.getInstance().cameraEntity instanceof Player player) {
            var pos = player.getOnPos();
            int offset = 4;
            thunderLevel = getStandardThunderLevel(1f, clientLevel, clientLevel.getBiome(Minecraft.getInstance().player.blockPosition()));
    ...
    public static Boolean isRainingAt(ClientLevel clientLevel, BlockPos blockPos) {
        ...
        return WeatherManager.getRainOrSnow(clientLevel,clientLevel.getBiome(Minecraft.getInstance().player.blockPosition()).value(), blockPos)
    ...
    public static boolean isThunderAt(ClientLevel clientLevel, BlockPos blockPos) {
        ...
        return getStandardThunderLevel(1.0f, clientLevel, clientLevel.getBiome(Minecraft.getInstance().player.blockPosition())) > 0.9f;
    }
