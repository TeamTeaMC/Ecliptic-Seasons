...
public class ImageHelper {
    public static void fixSnowImageColor(AnimationMetadataSection section, NativeImage original, AnimationMetadataSection snowySection, NativeImage snowyImage) {
        ...
        FrameSize snowFrameSize = snowySection.calculateFrameSize(snowyImage.getWidth(), snowyImage.getHeight());
    ...
    private static boolean eclipticseasons$isTop(int x, int y, NativeImage original) {
        return y != 0 && ColorHelper.getAlpha(original.getPixelRGBA(x, y - 1)) == 0;
    }
