...
public class LSO_ESUtil {
    ...
    public static void initAverageTemperatures() {
        ...
        List<ForgeConfigSpec.ConfigValue<List<? extends Float>>> configValueList = List.of(CompatModule.CommonConfig.legendarysurvivaloverhaul_springs,
        ...
        for (ForgeConfigSpec.ConfigValue<List<? extends Float>> listConfigValue : configValueList) {
            for (int i = 0; i < 6; i++) {
