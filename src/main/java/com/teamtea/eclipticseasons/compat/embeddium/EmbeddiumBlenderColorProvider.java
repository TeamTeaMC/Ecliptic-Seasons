...
public interface EmbeddiumBlenderColorProvider extends ColorProvider<BlockState>, BlockColor {
    ...
    @Override
    default void getColors(WorldSlice slice, BlockPos pos, BlockState state, ModelQuadView quad, int[] output) {
    ...
    private int getVertexColor(BlockAndTintGetter slice, BlockPos pos, BlockPos.MutableBlockPos scratchPos, ModelQuadView quad, BlockState state, int vertexIndex) {
    ...
    private int getColor(BlockAndTintGetter slice, BlockState state, BlockPos set) {
