...
public class SeasonalBackgroundMusic {
    ...
    public static final Codec<SeasonalBackgroundMusic> CODEC = RecordCodecBuilder.create(ins -> ins.group(
            ...
            CodecUtil.holderSetCodec(ESRegistries.SPECIAL_DAYS).optionalFieldOf("special_days", HolderSet.direct()).forGetter(o -> o.specialDays),
    ...
    @Builder.Default
    private final HolderSet<SpecialDays> specialDays = HolderSet.direct();
    @Builder.Default
    ...
    public record MusicBuilder(ResourceLocation sound, int minDelay, int maxDelay, boolean replaceCurrentMusic) {
        public static final Codec<MusicBuilder> CODEC = RecordCodecBuilder.create(
                i -> i.group(
                                ResourceLocation.CODEC.fieldOf("sound").forGetter(MusicBuilder::sound),
