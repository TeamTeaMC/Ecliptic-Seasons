...
public abstract class MixinModelManager {
    ...
    //private CompletableFuture<Map<Identifier, List<BlockStateModelLoader.LoadedJson>>> eclipticseasons$loadBlockStates_before_loadModelDef(
    //        CompletableFuture<Map<Identifier, List<BlockStateModelLoader.LoadedJson>>> original,
