...
import com.teamtea.eclipticseasons.common.misc.CustomRandomTick2;
...
public final class CustomRandomTickHandler {
    ...
    //     if (event.phase.equals(TickEvent.Phase.END) && CommonConfig.Temperature.iceMelt.get() && !event.level.isClientSide()) {
