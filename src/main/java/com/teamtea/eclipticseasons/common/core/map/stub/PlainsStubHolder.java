 ...
 */
public class PlainsStubHolder {

    /**
     * Emergency fallback instance representing the standard Plains biome.
     */
    public static final Holder.Reference<Biome> PLAINS = createStubBiomeHolderReference(
     ...
     */
    public static final Holder.Reference<Biome> VOID =  createStubBiomeHolderReference(
            Holder.Reference.Type.STAND_ALONE,
            new DummyHolderOwner<>(),
            Biomes.THE_VOID,
    ...
    private static Holder.Reference<Biome> createStubBiomeHolderReference(Holder.Reference.Type type, HolderOwner<Biome> owner,
                                                                   ResourceKey<Biome> key,
                                                                   Biome value) {
        Holder.Reference<Biome> standAlone = Holder.Reference.createStandAlone(owner, key);
        standAlone.bindValue(value);
        return standAlone;
    }

    // private PlainsStubHolder(Holder.Reference.Type type, HolderOwner<Biome> owner,
