...
public class BiomeClimateManager {
    ...
    public static void resetBiomeTemps(RegistryAccess registryAccess, boolean isServer) {
        ...
        if (registry.isEmpty()) {
            ...
            resetSomeMap(registryAccess, registry.get(),
                    BIOME_CLIMATE_MAP,
            ...
            resetSomeMap(registryAccess, registry3.get(),
                    SEASON_PHASE_MAP,
            ...
            resetSomeMap(registryAccess, registry4.get(),
            ...
            resetSomeMap(registryAccess, registry5.get(),
    ...
    public static <T, U, R, S> void resetSomeMap(RegistryAccess registryAccess,
        ...
        resetSomeMap(registryAccess, registry, useMap, ((key, t) -> biomeTransfer.apply(t)),
    ...
    public static <T, U, R, S> void resetSomeMap(RegistryAccess registryAccess,
        ...
        for (var value : ESSortInfo.sorted(registry.holders().toList())) {
            var pair = biomeTransfer.apply(value.key(), value.value());
