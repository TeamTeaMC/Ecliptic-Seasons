...
public class ESLootTables {
    ...
    public static final ResourceKey<LootTable> snowless_hometown = ResourceKey.create(Registries.LOOT_TABLE, ItemRegistry.snowless_hometown.getId().withPrefix("gifts/"));
