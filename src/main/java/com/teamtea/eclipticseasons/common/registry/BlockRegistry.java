...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> autumn_greenhouse_core = BLOCK_DEFERRED_REGISTER.register("autumn_greenhouse_core", () -> new GreenHouseCoreBlock(Season.AUTUMN, BlockBehaviour.Properties.of().strength(0.5f).sound(SoundType.AMETHYST).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final RegistryObject<Block> winter_greenhouse_core = BLOCK_DEFERRED_REGISTER.register("winter_greenhouse_core", () -> new GreenHouseCoreBlock(Season.WINTER, BlockBehaviour.Properties.of().strength(0.5f).sound(SoundType.AMETHYST).noOcclusion().pushReaction(PushReaction.DESTROY)));
    public static final RegistryObject<Block> greenhouse_core_container = BLOCK_DEFERRED_REGISTER.register("greenhouse_core_container", () -> new GreenHouseFrameBlock(BlockBehaviour.Properties.of().strength(0.5f).sound(SoundType.AMETHYST).noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistryObject<Block> block_in_copper_grate_block = BLOCK_DEFERRED_REGISTER.register("block_in_copper_grate_block", () -> new BlockInCopperGrateBlock( BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).noOcclusion()));
