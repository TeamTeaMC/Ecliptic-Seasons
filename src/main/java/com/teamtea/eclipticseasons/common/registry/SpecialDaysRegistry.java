...
public class SpecialDaysRegistry {
    ...
    public static void bootstrap(BootstapContext<SpecialDays> context) {
        context.register(FLOWER_FESTIVAL, SpecialDays.builder()
                .term(SolarTerm.INSECTS_AWAKENING)
                .start(0.75f)
                .end(1.0f)
                .title(Component.translatable(FLOWER_FESTIVAL.location().toLanguageKey(ESRegistries.SPECIAL_DAYS.location().getPath())))
                .build());
        ...
        context.register(SPRING_FESTIVAL, SpecialDays.builder()
                ...
                .start(0.0f)
                .end(1.0f)
                .title(Component.translatable(SPRING_FESTIVAL.location().toLanguageKey(ESRegistries.SPECIAL_DAYS.location().getPath())))
                .build());
        ...
        context.register(SPRING_OUTING, SpecialDays.builder()
                ...
                .start(0.0f)
                .end(0.15f)
                .title(Component.translatable(SPRING_OUTING.location().toLanguageKey(ESRegistries.SPECIAL_DAYS.location().getPath())))
                .build());
        ...
        context.register(EASTER, SpecialDays.builder()
                ...
                .start(0.2f)
                .end(0.35f)
                .title(Component.translatable(EASTER.location().toLanguageKey(ESRegistries.SPECIAL_DAYS.location().getPath())))
                .build());
        ...
        context.register(CHINESE_VALENTINES_DAY, SpecialDays.builder()
                ...
                .start(0.3f)
                .end(0.45f)
                .title(Component.translatable(CHINESE_VALENTINES_DAY.location().toLanguageKey(ESRegistries.SPECIAL_DAYS.location().getPath())))
                .build());
        ...
        context.register(MID_AUTUMN, SpecialDays.builder()
                ...
                .start(0.7f)
                .end(1.0f)
                .title(Component.translatable(MID_AUTUMN.location().toLanguageKey(ESRegistries.SPECIAL_DAYS.location().getPath())))
                .build());
        ...
        context.register(CHRISTMAS, SpecialDays.builder()
                ...
                .start(0.25f)
                .end(0.4f)
                .title(Component.translatable(CHRISTMAS.location().toLanguageKey(ESRegistries.SPECIAL_DAYS.location().getPath())))
                .build());
        ...
        context.register(NEW_YEAR, SpecialDays.builder()
                ...
                .start(0.7f)
                .end(0.85f)
                .title(Component.translatable(NEW_YEAR.location().toLanguageKey(ESRegistries.SPECIAL_DAYS.location().getPath())))
                .build());
    }
