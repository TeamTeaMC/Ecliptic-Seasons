...
public class ItemRegistry {
    ...
    public static final DeferredHolder<Item, BlockItem> spring_greenhouse_core_item = ITEM_DEFERRED_REGISTER.register("spring_greenhouse_core", () -> new GreenhouseCoreBlockItem((GreenHouseCoreBlock) BlockRegistry.spring_greenhouse_core.get(), (new Item.Properties())));
    public static final DeferredHolder<Item, BlockItem> summer_greenhouse_core_item = ITEM_DEFERRED_REGISTER.register("summer_greenhouse_core", () -> new GreenhouseCoreBlockItem((GreenHouseCoreBlock) BlockRegistry.summer_greenhouse_core.get(), (new Item.Properties())));
    public static final DeferredHolder<Item, BlockItem> autumn_greenhouse_core_item = ITEM_DEFERRED_REGISTER.register("autumn_greenhouse_core", () -> new GreenhouseCoreBlockItem((GreenHouseCoreBlock) BlockRegistry.autumn_greenhouse_core.get(), (new Item.Properties())));
    public static final DeferredHolder<Item, BlockItem> winter_greenhouse_core_item = ITEM_DEFERRED_REGISTER.register("winter_greenhouse_core", () -> new GreenhouseCoreBlockItem((GreenHouseCoreBlock) BlockRegistry.winter_greenhouse_core.get(), (new Item.Properties())));

    public static final DeferredHolder<Item, Item> spring_greenhouse_essence_item = ITEM_DEFERRED_REGISTER.register("spring_greenhouse_essence", () -> new GreenhouseEssenceItem((new Item.Properties())));
    public static final DeferredHolder<Item, Item> summer_greenhouse_essence_item = ITEM_DEFERRED_REGISTER.register("summer_greenhouse_essence", () -> new GreenhouseEssenceItem((new Item.Properties())));
    public static final DeferredHolder<Item, Item> autumn_greenhouse_essence_item = ITEM_DEFERRED_REGISTER.register("autumn_greenhouse_essence", () -> new GreenhouseEssenceItem((new Item.Properties())));
    public static final DeferredHolder<Item, Item> winter_greenhouse_essence_item = ITEM_DEFERRED_REGISTER.register("winter_greenhouse_essence", () -> new GreenhouseEssenceItem((new Item.Properties())));
