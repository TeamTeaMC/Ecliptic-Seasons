...
public class BlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<HumidityModifierBlockEntity>> humidity_modifier = BLOCK_ENTITY_TYPE_DEFERRED_REGISTER.register("humidity_modifier", () -> BlockEntityType.Builder.of(HumidityModifierBlockEntity::new, BlockRegistry.humidity_tank.get(), BlockRegistry.dehumidifier.get()).build(null));
