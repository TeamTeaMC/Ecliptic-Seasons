...
public class BlockEntityRegistry {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockInCopperGrateBlockEntity>> block_in_copper_grate_block_entity_type = BLOCK_ENTITY_TYPE_DEFERRED_REGISTER.register("block_in_copper_grate_block", () -> new BlockEntityType<>(BlockInCopperGrateBlockEntity::new, BlockRegistry.block_in_wooden_grate_block.get()));

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<HumidityModifierBlockEntity>> humidity_modifier = BLOCK_ENTITY_TYPE_DEFERRED_REGISTER.register("humidity_modifier", () -> new BlockEntityType<>(HumidityModifierBlockEntity::new, BlockRegistry.humidity_tank.get(), BlockRegistry.dehumidifier.get()));
}
