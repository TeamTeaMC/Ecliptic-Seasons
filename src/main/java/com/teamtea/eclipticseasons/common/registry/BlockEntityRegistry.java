...
public class BlockEntityRegistry {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<HumidityTankBlockEntity>> humidity_tank = BLOCK_ENTITY_TYPE_DEFERRED_REGISTER.register("humidity_tank", () -> BlockEntityType.Builder.of(HumidityTankBlockEntity::new, BlockRegistry.humidity_tank.get()).build(null));
