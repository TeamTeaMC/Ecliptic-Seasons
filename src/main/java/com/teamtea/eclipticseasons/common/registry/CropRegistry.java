...
public class CropRegistry {
    ...
    private static final ResourceKey<CropGrowControlBuilder> base = createKey("templates/wheat");
    ...
    public static void bootstrap(BootstapContext<CropGrowControlBuilder> context) {
        ...
        Optional<HolderSet<Block>> icePredicate = Optional.of(blockHolderGetter.getOrThrow(BlockTags.ICE));

        context.register(SPRING, new CropGrowControlBuilder(
                temperate,
                createTagPredicate(SPRING),
                HolderSet.direct(), emptyGP, emptyGP2,
    ...
    public static void bootstrap2(BootstapContext<CropGrowControlBuilder> context) {
        ...
        context.register(createKey("wheat"), new CropGrowControlBuilder(
                ...
                new Enum2ObjectMap<>(Map.of(SolarTerm.BEGINNING_OF_SPRING, GrowParameter.builder()
