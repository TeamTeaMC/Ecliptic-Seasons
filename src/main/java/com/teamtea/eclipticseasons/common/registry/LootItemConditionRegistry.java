...
public class LootItemConditionRegistry {
    ...
    public static final RegistryObject<LootItemConditionType> SEASON = LOOT_ITEM_CONDITION_TYPE_DEFERRED_REGISTER.register("season", () ->new LootItemConditionType(SeasonCondition.Serializer.INSTANCE));
