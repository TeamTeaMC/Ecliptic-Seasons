...
public class LootItemConditionRegistry {
    ...
    public static final DeferredHolder<LootItemConditionType, LootItemConditionType> SEASONAL_SIMULATION_LEVEL = LOOT_ITEM_CONDITION_TYPE_DEFERRED_REGISTER.register("seasonal_simulation_level", () -> new LootItemConditionType(SeasonalSimulationLevelLootCondition.CODEC));
